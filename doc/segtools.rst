...
- :ref:`segtools-gmtk-parameters <segtools-gmtk-parameters>`:
   Analyzes `GMTK <http://ssli.ee.washington.edu/~bilmes/gmtk/>`_ emission parameters and state transitions.
...
generated by `GMTK <http://ssli.ee.washington.edu/~bilmes/gmtk/>`_. This is most useful with segmentations generated using
the Segway framework, created by Michael Hoffman.
